...
class Shared extends Localizable(Events()) {
    ...
    get currentThemeId() {
        const themeId = BrowserHelper.queryString.theme || BrowserHelper.getLocalStorageItem('b-example-theme') || defaultTheme;

        // map old themes that were renamed
